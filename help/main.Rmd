...
####  BatchSerer is a web server for batch effect evaluation, visualization and correction. It's mainly based on following R packages:
...
#### which are further wrapped by [`R/Shiny`]('http://shiny.rstudio.com/'). 
